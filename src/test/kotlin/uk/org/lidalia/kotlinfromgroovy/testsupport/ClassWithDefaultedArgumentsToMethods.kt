...
class ClassWithDefaultedArgumentsToMethods {
    ...
    fun functionWithOneDefaultedArgument(
    ...
    fun functionWithTwoArgumentFirstDefaulted(
        argument1: String = "argument1",
        argument2: String,
    ) {
        calls += Call(
    ...
    fun functionWithTwoArgumentsSecondDefaulted(
        argument1: String,
    ...
    fun functionWithOneNullableArgumentDefaultedToNotNull(
        argument1: String? = "argument1",
    ) {
        calls += Call(
    ...
    fun functionWithOneNullableArgumentDefaultedToNull(
